...
export const GlobalContextProvider = ({children}) =>
{
    ...
    const getUpcomingAnime = async () => {
        dispatch({type: LOADING})
        const response = await fetch(`${baseUrl}/top/anime?filter=upcoming&order_by=popularity&sort=asc&sfw`);
        const data = await response.json();
    ...
    const getAiringAnime = async () => {
        dispatch({type: LOADING})
        const response = await fetch(`${baseUrl}/top/anime?filter=airing&order_by=popularity&sort=asc&sfw`);
        const data = await response.json();
